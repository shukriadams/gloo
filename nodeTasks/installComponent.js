    ...
    function bowerGet(pkg, url, tag){
        ...
        bower.commands
            ...
            .on('end', function (installed) {
                ...
                var componentTargetPath = fileUtils.resolveComponent(config.glooConfig.componentFolder, pkg);
                componentTargetPath = componentTargetPath || path.join(config.glooConfig.componentFolder, pkg);
